...
<div class="card mb-5">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="true" href="index?page=<?php echo $request;?>">รายการร้องขอ</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index?page=<?php echo $confirm;?>">รายการรอจบงาน</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
        <?= manage::gettable($conn2); ?>
    </div>
</div>
<!--              <script>
