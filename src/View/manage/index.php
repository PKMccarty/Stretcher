...
<style>
  .small-btn {
    padding: 5px 5px; /* ปรับขนาดของ padding ตามต้องการ */
    font-size: 12px; /* หรือค่าที่คุณต้องการ */
  }
</style>
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg mb-4">
                        <?php
                            if($page == 'request'){
                                include('tables_data_show_request.php');
                            }
                            else if($page == 'process'){
                                include('tables_data_show_process.php');
                            }
                            else if($page == 'success'){
                                include('tables_data_show_succ.php');
                            }
                            else if($page == 'confirm'){
                                include('tables_data_show_confirm.php');
                            }
                        ?>
                        ...
                        <div class="modal fade" id="exampleModal21" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">ยืนยัน จบงาน</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form action="job_confirm.php" method="post">
                                        <div class="modal-body2 m-5">
                                            <input type="hidden" class="form-control" name="hn" id="recipient2">
                                        </div>
                                        <div class="modal-body3 m-5">
                                        ...
                                        <div class="modal-body3 m-5">
                                            <label for="">เหตุผลจบงานแทน Ward รับผู้ป่วย</label>
        ...
        <script>
             $(document).ready(function() {
                const page = 10;
            $('#showingdisplay').DataTable({"ordering": false,"pageLength": page});
            $('#showingdisplay2').DataTable({"ordering": false,"pageLength": page});
            $('#showingdisplay3').DataTable({"ordering": false,"pageLength": page});
        });
        </script>
        <script>
            const exampleModal21 = document.getElementById('exampleModal21')
            exampleModal21.addEventListener('show.bs.modal', event => {
                ...
                const modalBodyInput = exampleModal21.querySelector('.modal-body2 input')
                const modalBodyInput2 = exampleModal21.querySelector('.modal-body3 input')
                const modalBodyInput3 = exampleModal21.querySelector('.modal-body4 input')
